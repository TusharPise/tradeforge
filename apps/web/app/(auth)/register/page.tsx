...
import { registerSchema, RegisterDto } from '@tradeforge/validation';
...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-950 p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/3 w-[400px] h-[400px] bg-cyan-500/8 rounded-full blur-[100px] animate-float"></div>
      <div className="absolute bottom-1/4 left-1/4 w-[300px] h-[300px] bg-emerald-500/8 rounded-full blur-[80px] animate-float-delay"></div>
      ...
      <div className="relative z-10 w-full max-w-md animate-in fade-in slide-in-from-bottom-6 duration-700">
        ...
        <Card className="w-full border-slate-800 bg-slate-900/70 backdrop-blur-xl shadow-2xl">
          <CardHeader className="space-y-1 text-center">
            <CardTitle className="text-2xl font-bold tracking-tight text-slate-100">Create an Account</CardTitle>
            <CardDescription className="text-slate-400">Join TradeForge to start paper trading</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="John" className="border-slate-800 bg-slate-950 text-slate-100 focus:border-emerald-500/50 focus:ring-emerald-500/20" {...field} />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Doe" className="border-slate-800 bg-slate-950 text-slate-100 focus:border-emerald-500/50 focus:ring-emerald-500/20" {...field} />
                        </FormControl>
                        <FormMessage className="text-red-400" />
                      </FormItem>
                    )}
          ...
          <CardFooter className="flex justify-center">
            <div className="text-sm text-slate-500">
              ...
              <Button variant="link" className="text-emerald-400 p-0 hover:text-emerald-300" onClick={() => router.push('/login')}>
                Sign in
              </Button>
            </div>
          </CardFooter>
